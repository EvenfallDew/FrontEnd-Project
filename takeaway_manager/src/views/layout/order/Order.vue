		...
		<Card>
			...
			<main slot="content">
				...
				<el-table :data="tableData" border style="width: 100%">
					<el-table-column fixed prop="num" label="订单号" width="100"></el-table-column>
					...
					<el-table-column prop="time" label="送达时间" width="100"></el-table-column>
					<el-table-column prop="remark" label="用户备注" width="100"></el-table-column>
