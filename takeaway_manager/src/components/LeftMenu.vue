<template>
    <div class="left-menu">
        <el-menu router unique-opened :default-active="this.$route.path" class="el-menu-vertical-demo"
            background-color="#304156" text-color="#fff" active-text-color="#3f9af8">
            <!-- 后台首页 -->
            ...
            <el-submenu index="/acc">
                <template slot="title">
                    <i class="iconfont icon-menu-acc"></i>
                    <span>账号管理</span>
                </template>
                <el-menu-item-group>
                    <el-menu-item index="/acc/acc-list">账号列表</el-menu-item>
                    <el-menu-item index="/acc/acc-add">账号添加</el-menu-item>
                    <el-menu-item index="/acc/acc-eidit">修改密码</el-menu-item>
                </el-menu-item-group>
            </el-submenu>
            <!-- 销售统计 -->
            <el-submenu index="/count">
                <template slot="title">
                    <i class="iconfont icon-menu-count"></i>
                    <span>销售统计</span>
                </template>
                <el-menu-item-group>
                    <el-menu-item index="/count/count-goods">商品统计</el-menu-item>
                    <el-menu-item index="/count/count-order">订单统计</el-menu-item>
                </el-menu-item-group>
            </el-submenu>
        </el-menu>
    </div>
